...
`sr-roadmap-l1i.1.9`; independent adversarial certification belongs to `.1.12`.
...
`--case ID` may be repeated for a development subset. It cannot produce a complete
...
expected_identity)` and separately require `runner_status == "passed"`.
